...
export interface CompanySettings {
  ...
  /** When true + root has pipeline-mode label, worker subtasks auto-release after submit. */
  autoReleasePipelineSubtasks?: boolean;
  /** When true + root has pipeline-mode label, split multi-chapter drafting into per-chapter subtasks. */
  splitChapterSubtasks?: boolean;

}

/** Root task label enabling opt-in pipeline behaviors. */
